...
<div class="more text-center">
	...
	<c:if test="${maxPages ne 1}">
		...
		<c:if test="${page ne 1}">
		  ...
		  <a href="${first}" title="First"><i class="fa fa-angle-double-left"></i></a>
		</c:if>
		<c:if test="${page gt 1}">
		  ...
		  <a href="${previous}" title="Previous"><i class="fa fa-angle-left"></i></a>
		</c:if>
		<c:out value=" " />
		...
		<c:if test="${page lt maxPages}">
		  ...
		  <a href="${next}" title="Next"><i class="fa fa-angle-right"></i></a>
		</c:if>
		<c:if test="${page ne maxPages}">
		  ...
		  <a href="${last}" title="Last"><i class="fa fa-angle-double-right"></i></a>
		</c:if>
	</c:if>
</div>