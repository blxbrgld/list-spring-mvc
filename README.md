...
<li>Create src/main/resources/configuration.properties file and add all the required properties in it (configuration.sample contains all the required properties, you can edit these values).</li>
</ol>
